<!-- .slide: data-background="../../reveal.js/img/2020/uc/bg-4.png" -->
...
### Query tips
  <div style="display:inline">
   <img src="image/server-vs-client-points.png" style="border:0;background:none;box-shadow:none;height:420px;">
  </div>
